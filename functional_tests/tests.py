...
class NewVisitorTest(StaticLiveServerTestCase):
    ...
    def test_multiple_users_can_start_lists_at_different_urls(self):
        ...
        # Now a new user called Francis comes along

        # # Use a new browser session to make sure no information spills over
        # # from Edith's cookies etc.
        self.browser.quit()
        self.browser = webdriver.Firefox()
    ...
    def test_layout_and_styling(self):
        """Make sure that CSS loads and that our input box is centered.
